...
namespace RegionReports.Data.Migrations
{
    ...
    [Migration("20220517074745_moved properties from assignment to asnGroup")]
    partial class movedpropertiesfromassignmenttoasnGroup
    {
            ...
            modelBuilder.Entity("RegionReports.Data.Entities.ReportAssignmentGroup", b =>
                {
                    ...
                    b.HasIndex("ReportRequestSurveyId")
                        .IsUnique()
                        .HasFilter("[ReportRequestSurveyId] IS NOT NULL");

                    b.HasIndex("ReportRequestTextId")
                        .IsUnique()
                        .HasFilter("[ReportRequestTextId] IS NOT NULL");
            ...
            modelBuilder.Entity("RegionReports.Data.Entities.ReportAssignmentGroup", b =>
                {
                    b.HasOne("RegionReports.Data.Entities.ReportRequestSurvey", "ReportRequestSurvey")
                        .WithOne("AssignmentsGroup")
                        .HasForeignKey("RegionReports.Data.Entities.ReportAssignmentGroup", "ReportRequestSurveyId");

                    b.HasOne("RegionReports.Data.Entities.ReportRequestText", "ReportRequestText")
                        .WithOne("AssignmentsGroup")
                        .HasForeignKey("RegionReports.Data.Entities.ReportAssignmentGroup", "ReportRequestTextId");
